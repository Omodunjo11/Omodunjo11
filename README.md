...
**Portfolio:** [lapoodunjo.com](https://lapoodunjo.com) · **Email:** odunjoonaolapo@gmail.com · **LinkedIn:** [linkedin.com/in/onaolapomichaelodunjo](https://linkedin.com/in/onaolapomichaelodunjo)

Forward Deployed Product Manager · AI Deployment & GTM Systems · Wharton MBA '26

Operator who deploys AI in production and builds the agentic systems that scale delivery — forward-deployed client work, GTM intelligence, and regulated enterprise ML. I ship outcomes, not roadmaps.

---

## Featured Work

Full case studies, architecture breakdowns, and outcomes live on the portfolio. Several production systems are private to protect IP.
...
## Public Engineering Repos

Open repos that demonstrate systems thinking, reliability design, deployment judgment, and hands-on implementation.
...
Older or superseded repos. Kept for history; active work lives elsewhere.
...
Reviewing my work as part of a hiring process?
...
Substack: [substack.com/@onaolapomichaelodunjo](https://substack.com/@onaolapomichaelodunjo)
...
**AI / ML** — RAG architecture · Embeddings · Vector search · LLM evaluation · Agentic workflows · Drift detection · HITL escalation

**Deployment & GTM** — Forward-deployed delivery · Signal ingest & scoring · CRM enrichment · Transcript intelligence · Cost-to-serve modeling

**Identity** — OAuth 2.0 · OIDC · SAML · Auth0 · JWT lifecycle · RBAC / ABAC · MFA

**Systems** — FastAPI · Next.js · pgvector · Latency modeling (P50/P95/P99) · Event instrumentation · Schema governance
...
• User intent ≠ system confirmation  
• Ground before generating  
• Instrument before optimizing  
• Production > prototype  
• Manual today → agent tomorrow  
